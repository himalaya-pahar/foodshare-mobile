...
const styles = StyleSheet.create({
  ...
  segmentedControl: { flexDirection: "row", padding: 4, borderRadius: 14, backgroundColor: "#E1EDE4" },
  segment: { flex: 1, alignItems: "center", borderRadius: 11, paddingVertical: 10 },
  segmentActive: { backgroundColor: "#FFFFFF" },
  segmentText: { color: "#607567", fontSize: 13, fontWeight: "800" },
  ...
  flowCard: { gap: 16, borderRadius: 22, padding: 18, backgroundColor: "#FFFFFF" },
  flowHeader: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 12 },
  flowHeaderCopy: { flex: 1, gap: 5 },
  foodName: { color: "#173526", fontSize: 18, fontWeight: "800", lineHeight: 24 },
  postedAt: { color: "#6E8275", fontSize: 12, lineHeight: 18 },
  statusBadge: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6, backgroundColor: "#E2F4E8" },
  ...
  dot: { zIndex: 1, width: 21, height: 21, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#CBD9CE", borderRadius: 11, backgroundColor: "#FFFFFF" },
  ...
  stepLabel: { marginTop: 7, color: "#8A9A8E", fontSize: 10, fontWeight: "800", textAlign: "center" },
  stepLabelReached: { color: "#176B43" },
  stepTime: { marginTop: 4, color: "#7A8C80", fontSize: 9, lineHeight: 13, textAlign: "center" },
  ...
  pageNumber: { minWidth: 68, color: "#607568", fontSize: 12, fontWeight: "700", textAlign: "center" },
